...
func (a *Atom) createService() {
	...
	code := strings.ReplaceAll(str, "MODNAME", a.ModName)
	code = strings.ReplaceAll(str, "Department", a.Name)
	fileName := LowFirst(a.Name)
	code = strings.ReplaceAll(code, "department", fileName)
